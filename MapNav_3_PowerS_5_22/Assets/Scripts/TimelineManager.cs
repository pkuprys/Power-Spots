...
public class TimelineManager : MonoBehaviour {
    ...
    private IEnumerator RenderTimeline(){
        ...
        foreach(Team team in teams){
            GameObject.Find(team.Color + REVEAL + ONE).renderer.enabled = team.IsDayOneCardVisible();
            GameObject.Find(team.Color + REVEAL + TWO).renderer.enabled = team.IsDayTwoCardVisible();
        }
    }
}