...
// 	url="http://open.mapquestapi.com/staticmap/v4/getmap?key="+key+"&size="+mapSize[indexSize].ToString()+","+mapSize[indexSize].ToString()+"&zoom="+zoom+"&type="+maptype[index]+"&center="+fixLat+","+fixLon+"&scalebar=false";
	...
	//	map with streetnames names and landmark markers
	...
	//map from snazzyMaps VERY LIGHT                                                                                                                                                                                                         water = blue                                                             tops of buildings= dark                            roads = white                                                                                yard around buildings = black                                     don't know = white                                                                                                           quadGrass = reddish  
		//url="http://maps.google.com/maps/api/staticmap?center="+fixLat+","+fixLon+"&zoom="+zoom+"&size=640x640&scale=2&format=png32&maptype=roadmap&sensor=false&style=feature:all%7Celement:labels%7Cvisibility:off&style=feature:water%7Celement:geometry%7Ccolor:0x8da9cb&style=feature:landscape%7Celement:geometry%7Ccolor:0xffffff&style=feature:road%7Celement:geometry%7Ccolor:0xbbbbbb%7Cvisibility:simplified%7Clightness:-37&style=feature:poi%7Celement:geometry%7Ccolor:0xeeeeee&style=feature:administrative%7Celement:geometry%7Ccolor:0xffffff%7Cweight:0.6%7Cvisibility:on%7Celement:labels.icon%7Cvisibility:off&style=feature:poi.park%7Celement:geometry%7Ccolor:0xdddddd";
